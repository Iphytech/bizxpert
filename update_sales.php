...
<head>
	...
	<title>www.innomacars.com | Update Supplier</title>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
					...
					jAlert('<?php echo  $msg; ?>', 'Innoma Cars');
			...
			//echo "<script>window.open('add_sales_print.php?sid=$autoid','myNewWinsr','width=620,height=800,toolbar=0,menubar=no,status=no,resizable=yes,location=no,directories=no');
