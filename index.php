...
<div id="top-bar">
	...
	<!------<div id="header">
		...
		<div class="page-full-width cf">
			...
			<!----------<a href="" id="company-branding" class="fr"  target="blank"><img src="<?php //if(isset($_SESSION['logo'])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/posnic.png"; } ?>" alt="Point of Sale" /></a>
    ...
    <div style="width:600px; float:left">
        <span style="margin-left: 10px; font-weight: bold; font-size:20px; color: #0060BF;"><img src="images/lol.png" width="505" height="131"></span></div>
        
          
    <div style="width:650px; float:right">
        <span style="margin-left: 10px;font-weight: bold; font-size:20px; color: #0060BF; margin-right:50px"><img src="images/test.png" width="505" height="131"></span></div>
